...
```bash
echo "http://$(kubectl get svc -n python-api-app-2-dev -o jsonpath={.items[].status.loadBalancer.ingress[0].hostname}):5000/api/v1/info"
```

## Images

[Dockerhub/johnyunez/python-api-app-2](https://hub.docker.com/repository/docker/johnyunez/python-api-app-2)
